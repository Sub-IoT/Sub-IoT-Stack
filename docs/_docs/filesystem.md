...
The platform should define the blockdevice to use by defining a `static blockdevice_t* d7a_systemfiles_blockdevice` in it's platform.h (see for instance `stack/framework/hal/platforms/B_L072Z_LRWAN1/inc/platform.h`).
