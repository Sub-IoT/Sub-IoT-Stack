...
#ifndef PLATFORM_IFEST
    #error Mismatch between the configured platform and the actual platform. Expected PLATFORM_PLATFORM_IFEST to be defined
#endif
...
#define UART_BAUDRATE PLATFORM_IFEST_UART_BAUDRATE
...
// UART0 location
#define UART_PIN_TX         B4
#define UART_PIN_RX         B3
