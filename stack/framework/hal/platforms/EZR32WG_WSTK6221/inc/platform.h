...
#ifndef PLATFORM_EZR32WG_WSTK6221
    #error Mismatch between the configured platform and the actual platform. Expected PLATFORM_EZR32WG_WSTK6221 to be defined
#endif
...
#define UART_BAUDRATE PLATFORM_EZR32WG_WSTK6221_UART_BAUDRATE
