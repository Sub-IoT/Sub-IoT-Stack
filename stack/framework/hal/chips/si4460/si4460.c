...
static void configure_channel(const channel_id_t* channel_id)
{
	...
	if(!hw_radio_channel_ids_equal(channel_id, &current_channel_id))
	{
		...
		case PHY_CLASS_LO_RATE:
			...
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_DECIMATION_CFG1_LR);
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_BCR_OSR_LR);
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_BCR_NCO_OFFSET_LR);
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_BCR_GAIN_LR);
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_AFC_WAIT_LR);
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_AFC_LIMITER_LR);
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_AGC_RFPD_DECAY_LR);
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_AGC_IFPD_DECAY_LR);
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_SPIKE_DET_LR);

			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_FREQ_CONTROL_CHANNEL_STEP_SIZE_LR);
...
#define RF_SET_PROPERTY_MODEM_DSA_QUAL 0x11, 0x20, 0x01, 0x5D, 0x05
		...
		case PHY_CLASS_NORMAL_RATE:
			...
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_BCR_NCO_OFFSET_NR);
			...
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_FREQ_CONTROL_CHANNEL_STEP_SIZE_NR);
...
#define RF_SET_PROPERTY_MODEM_DSA_QUAL 0x11, 0x20, 0x01, 0x5D, 0x09
		...
		case PHY_CLASS_HI_RATE:
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_DATA_RATE_HR);
			...
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_BCR_NCO_OFFSET_HR);
			...
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_FREQ_CONTROL_CHANNEL_STEP_SIZE_HR);
		...
		case PHY_BAND_433:
			ezradio_set_property(RADIO_CONFIG_SET_PROPERTY_MODEM_CLKGEN_BAND_434);
			assert(false);
...
#define RF_SET_PROPERTY_MODEM_IF_FREQ 0x11, 0x20, 0x03, 0x1B, 0x03, 0x80, 0x00
			...
			{
#define RF_SET_PROPERTY_MODEM_FREQ_DEV 0x11, 0x20, 0x03, 0x0A, 0x00, 0x0F, 0xC1
