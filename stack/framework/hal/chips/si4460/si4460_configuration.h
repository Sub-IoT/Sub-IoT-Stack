...
#define RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH (251)
...
#define RF_SET_PROPERTY_FRR_CTL_A_MODE 0x11, 0x02, 0x01, 0x00, 0x02

#define RF_SET_PROPERTY_FRR_CTL_B_MODE 0x11, 0x02, 0x01, 0x01, 0x03

#define RF_SET_PROPERTY_FRR_CTL_C_MODE 0x11, 0x02, 0x01, 0x02, 0x04

#define RF_SET_PROPERTY_FRR_CTL_D_MODE 0x11, 0x02, 0x01, 0x03, 0x0A

#define RF_SET_PROPERTY_INT_CTL_ENABLE 0x11, 0x01, 0x01, 0x00, 0x01

#define RF_SET_PROPERTY_INT_CTL_PH_ENABLE 0x11, 0x01, 0x01, 0x01, 0x39 //0x3B //0x38

#define RF_SET_PROPERTY_INT_CTL_MODEM_ENABLE 0x11, 0x01, 0x01, 0x02, 0x00

#define RF_SET_PROPERTY_INT_CTL_CHIP_ENABLE 0x11, 0x01, 0x01, 0x03, 0x00//0x20

#define RF_SET_PROPERTY_PA_MODE 0x11, 0x22, 0x01, 0x00, 0x08//use current mode 0x09 use class-E amplifier mode 0x08
...
//#define RF_SET_PROPERTY_SYNC_BITS 0x11, 0x11, 0x04, 0x01, 0xD0, 0xE6, 0x00, 0x00
#define RF_SET_PROPERTY_SYNC_BITS 0x11, 0x11, 0x04, 0x01, 0x67, 0x0B,  0x00, 0x00

#define RF_SET_PROPERTY_SYNC_CONFIG2 0x11, 0x11, 0x01, 0x05, 0x00

#define RF_SET_PROPERTY_PKT_CRC_CONFIG 0x11, 0x12, 0x01, 0x00, 0x85

#define RF_SET_PROPERTY_PKT_WHT_POLY 0x11, 0x12, 0x02, 0x01, 0x01, 0x08
...
#define RF_SET_PROPERTY_PKT_CONFIG1 0x11, 0x12, 0x01, 0x06, 0x02
...
#define RF_SET_PROPERTY_PKT_LEN_ADJUST 0x11, 0x12, 0x01, 0x0A, 0xFE
#else
#define RF_SET_PROPERTY_PKT_LEN_ADJUST 0x11, 0x12, 0x01, 0x0A, 0x00
#endif

#define RF_SET_PROPERTY_PKT_TX_THRESHOLD 0x11, 0x12, 0x01, 0x0B, 0x05 //0x30

#define RF_SET_PROPERTY_PKT_RX_THRESHOLD 0x11, 0x12, 0x01, 0x0C, 0x10 //0x30

#define RF_SET_PROPERTY_PKT_FIELD_1_LENGTH 0x11, 0x12, 0x02, 0x0D, 0x00, 0x01

#define RF_SET_PROPERTY_PKT_FIELD_1_CONFIG 0x11, 0x12, 0x01, 0x0F, 0x06
...
#define RF_SET_PROPERTY_PKT_FIELD_2_LENGTH 0x11, 0x12, 0x02, 0x11, 0x00, 0xFA

#define RF_SET_PROPERTY_PKT_FIELD_2_CONFIG 0x11, 0x12, 0x01, 0x13, 0x02

#ifdef HAL_RADIO_USE_HW_CRC
#define RF_SET_PROPERTY_PKT_FIELD_2_CRC_CONFIG 0x11, 0x12, 0x01, 0x14, 0x0A
#else
#define RF_SET_PROPERTY_PKT_FIELD_2_CRC_CONFIG 0x11, 0x12, 0x01, 0x14, 0x00
#endif
...
#define RF_SET_PROPERTY_PKT_RX_FIELD_1_CONFIG 0x11, 0x12, 0x01, 0x23, 0x02
...
#define RF_SET_PROPERTY_PKT_RX_FIELD_2_CONFIG 0x11, 0x12, 0x01, 0x27, 0x02
...
#define RF_SET_PROPERTY_MODEM_DATA_RATE 0x11, 0x20, 0x03, 0x03, 0x10, 0xF4, 0x3C

#define RF_SET_PROPERTY_MODEM_TX_NCO_MODE 0x11, 0x20, 0x04, 0x06, 0x09, 0x8C, 0xBA, 0x80

#define RF_SET_PROPERTY_MODEM_FREQ_DEV 0x11, 0x20, 0x03, 0x0A, 0x00, 0x07, 0xE0
...
#define RF_SET_PROPERTY_FREQ_CONTROL_FRAC 0x11, 0x40, 0x03, 0x01, 0x0B, 0x23, 0x72
...
#define RF_SET_PROPERTY_MODEM_FSK4_TH 0x11, 0x20, 0x02, 0x3D, 0x73, 0x33
...
#define RF_SET_PROPERTY_MODEM_RAW_EYE 0x11, 0x20, 0x02, 0x46, 0x01, 0x3F
...
#define RF_SET_PROPERTY_GLOBAL_WUT_CONFIG 0x11, 0x00, 0x00, 0x00, 0x00
...
#define RADIO_CONFIGURATION_DATA_BASE_FREQUENCY 863100000
#define RADIO_CONFIGURATION_DATA_BIT_ORDER FALSE
#define RADIO_CONFIGURATION_DATA_CENTER_FREQUENCY 863100000
...
#else
#define RADIO_CONFIGURATION_DATA_CHECK_CRC_1 FALSE
#endif
...
#define RADIO_CONFIGURATION_DATA_ENABLE_CRC_1 FALSE
#endif
...
#define RADIO_CONFIGURATION_DATA_FLD_CRC_ENDIAN 1
...
#define RADIO_CONFIGURATION_DATA_FRR_CTL_A_MODE 2
#define RADIO_CONFIGURATION_DATA_FRR_CTL_B_MODE 2
#define RADIO_CONFIGURATION_DATA_FRR_CTL_C_MODE 9
#define RADIO_CONFIGURATION_DATA_FRR_CTL_D_MODE 10
...
#define RADIO_CONFIGURATION_DATA_PACKET_HANDELR_HW_INTERRUPT 60
...
#define RADIO_CONFIGURATION_DATA_PKT_FIELD_LENGTH_1 250
...
#define RADIO_CONFIGURATION_DATA_PKT_FIELD_WHITEN_0 TRUE
#define RADIO_CONFIGURATION_DATA_PKT_FIELD_WHITEN_1 TRUE
...
#ifdef HAL_RADIO_USE_HW_CRC
#define RADIO_CONFIGURATION_DATA_PKT_LENGTH_ADJUST -2
#else
...
#define RADIO_CONFIGURATION_DATA_PKT_RESET_DATAWHITENING TRUE
...
#define RADIO_CONFIGURATION_DATA_PKT_RX_FIELD_WHITEN_0 TRUE
#define RADIO_CONFIGURATION_DATA_PKT_RX_FIELD_WHITEN_1 TRUE
...
#define RADIO_CONFIGURATION_DATA_PKT_WHITENING_POLY 264
...
#define RADIO_CONFIGURATION_DATA_POWER_PA_MODE 1
...
#define RADIO_CONFIGURATION_DATA_RFPARAM_RSSI_LATCH 2
#define RADIO_CONFIGURATION_DATA_RFPARAM_RSSI_THRESHOLD 0
