 ...
 *****************************************************************************/
/* @Dvdakker:
 * Disable this for now: we had some weird printf releated errs in the olden olden days
 * & the c lib should provide this. If it doesn't work we can always re-enable it...
...
/* outcomment these until we figure out what the API will look like
