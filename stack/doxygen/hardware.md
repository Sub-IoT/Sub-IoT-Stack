...
A disadvantage of this platform is that you need to attach an external CC1101 .
...
The RF module is a plug-in module for the Giant Gecko (GG) and is developed by University of Antwerp. The Giant Gecko is a development kit from Silicon Labs, this contains a cortex M3 chip and several sensors. 
An advantage is that the programmer is already included on the board. The setup on picture is all you need to start working with the DASH7 open software stack. 
...
Schematics and board file are available. If there are any questions, contact us through the Github mailing list.
Schematic: HTML_EXTRA_FILES = ../documents/GG-CC1101_v1.pdf
Eagle files: HTML_EXTRA_FILES = ../documents/GG_CC1101.zip
...
The programmer is not included in the wizzikit, we recommend to use the TIMSP-FET430UIF  programmer or the OLimex MSP430-JTAG-TINY-V2 programmer. 
The DASH7 open software stack supports the Wizzilab platform.


![Wizzikit](WizziKit.png)

Datasheet (includes schematic): HTML_EXTRA_FILES = ../documents/WizziKit-Datasheet.pdf
