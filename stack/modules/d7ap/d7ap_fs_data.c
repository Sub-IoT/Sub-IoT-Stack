...
system_files = [
  ...
  NotImplementedFile(SystemFileIds.D7AALP_RFU_1D.value, 12),
  NotImplementedFile(SystemFileIds.D7AALP_RFU_1E.value, 35),
  NotImplementedFile(SystemFileIds.D7AALP_RFU_1F.value, 43),
...
__attribute__((used)) uint16_t files_offset[] = {
  ...
  0x220,	// D7AALP_RFU_1D - 29 (length 12))
  0x238,	// D7AALP_RFU_1E - 30 (length 35))
  0x267,	// D7AALP_RFU_1F - 31 (length 43))
  0x29e,	// ACCESS_PROFILE_0 - 32 (length 65))
  0x2eb,	// ACCESS_PROFILE_1 - 33 (length 65))
  0x338,	// ACCESS_PROFILE_2 - 34 (length 65))
  0x385,	// ACCESS_PROFILE_3 - 35 (length 65))
  0x3d2,	// ACCESS_PROFILE_4 - 36 (length 65))
  0x41f,	// ACCESS_PROFILE_5 - 37 (length 65))
  0x46c,	// ACCESS_PROFILE_6 - 38 (length 65))
  0x4b9,	// ACCESS_PROFILE_7 - 39 (length 65))
  0x506,	// ACCESS_PROFILE_8 - 40 (length 65))
  0x553,	// ACCESS_PROFILE_9 - 41 (length 65))
  0x5a0,	// ACCESS_PROFILE_10 - 42 (length 65))
  0x5ed,	// ACCESS_PROFILE_11 - 43 (length 65))
  0x63a,	// ACCESS_PROFILE_12 - 44 (length 65))
  0x687,	// ACCESS_PROFILE_13 - 45 (length 65))
  0x6d4,	// ACCESS_PROFILE_14 - 46 (length 65))
  //[[[end]]] (checksum: 6331da56eb3f1a3e263a06961b9803d9)
};
...
__attribute__((used)) uint8_t files_length[] = {
  ...
  0x18,	// D7AALP_RFU_1D - 29)
  0x2f,	// D7AALP_RFU_1E - 30)
  0x37,	// D7AALP_RFU_1F - 31)
  ...
  //[[[end]]] (checksum: 103dc42f2f5b0c139879794c2339430b)
};
...
__attribute__((used)) uint8_t d7ap_permanent_files_data[FRAMEWORK_FS_PERMANENT_STORAGE_SIZE] LINKER_SECTION_FS_SYSTEM_FILE = {
  ...
  0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 
  // D7AALP_RFU_1E - 30
  0x24, 0x23, 0xff, 0xff, 0x0, 0x0, 0x0, 0x23, 0x0, 0x0, 0x0, 0x23, 
  ...
  // D7AALP_RFU_1F - 31
  0x24, 0x23, 0xff, 0xff, 0x0, 0x0, 0x0, 0x2b, 0x0, 0x0, 0x0, 0x2b, 
  ...
  0x24, 0x23, 0xff, 0xff, 0x0, 0x0, 0x0, 0x41, 0x0, 0x0, 0x0, 0x41, 
  0x32, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xe, 0x56, 0xff, 0x0, 0x0, 0x0, 0x0, 0xe, 0x56, 0xff, 0x0, 0x0, 0x0, 0x0, 0xe, 0x56, 0xff, 0x0, 0x0, 0x0, 0x0, 0xe, 0x56, 0xff, 0x0, 0x0, 0x0, 0x0, 0xe, 0x56, 0xff, 0x0, 0x0, 0x0, 0x0, 0xe, 0x56, 0xff, 0x0, 0x0, 0x0, 0x0, 0xe, 0x56, 0xff, 0x0, 0x0, 0x0, 0x0, 0xe, 0x56, 0xff, 
  //[[[end]]] (checksum: d00718c24cc8d4234ac2df3b4a1012d8)
};
