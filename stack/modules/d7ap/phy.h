 ...
 */
__LINK_C error_t phy_send_packet(hw_radio_packet_t* packet, phy_tx_config_t* config);
...
error_t phy_send_packet_with_advertising(hw_radio_packet_t* packet, phy_tx_config_t* config, uint8_t dll_header_bg_frame[2], uint16_t eta);
