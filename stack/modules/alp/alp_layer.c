...
static void alp_layer_command_completed_from_lorawan(lorawan_stack_error_t error, uint8_t attempts);
...
void alp_layer_command_completed_from_lorawan(lorawan_stack_error_t error, uint8_t attempts)
{
  // TODO end session
